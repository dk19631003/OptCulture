...
/**
 * A request to perform a hold redemption transaction. A hold redemption transaction can be used to remove currency value in to a hold state from an account. It may also create and change customer information associated with an account.
 * 
 ...
 *         &lt;element name="leavingHeld" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlRootElement(name = "HoldRedemption")
public class HoldRedemption {
    ...
    /**
     * Gets the value of the leavingHeld property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getLeavingHeld() {
        return leavingHeld;
    }

    /**
     * Sets the value of the leavingHeld property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setLeavingHeld(String value) {
        this.leavingHeld = value;
    }
