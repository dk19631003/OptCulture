...
/**
 * A request to perform a merchandise return transaction. A merchandise return transaction can be used to add value to an account that is marked as store credit. It may also create and change customer information associated with an account.
 * 
...
@XmlRootElement(name = "MerchandiseReturn")
