...
public class SMSStatusCodes {
	...
	public static final Map<String, String> singaporeCampTypeMap = new LinkedHashMap<String, String>();
...
public static final Map<String, String> optInTypeMap = new HashMap<String, String>();
	...
	//TODO need to get username,password,feedid from DB
		...
		singaporeCampTypeMap.put(Constants.SMS_TYPE_NAME_OUTBOUND, Constants.SMS_TYPE_OUTBOUND+Constants.ADDR_COL_DELIMETER+"Y");
		singaporeCampTypeMap.put(Constants.SMS_TYPE_NAME_2_WAY, Constants.SMS_TYPE_2_WAY+Constants.ADDR_COL_DELIMETER+"Y");
		...
		campTypeMap.put(Constants.SMS_COUNTRY_SINGAPORE, singaporeCampTypeMap);
		...
		keywordRuleMap.put(Constants.SMS_COUNTRY_SINGAPORE, new String[] { "[a-z|A-Z]+","4","10","only alphabet"});//APP-4688
		...
		smsProgramlookupOverUserMap.put(Constants.SMS_COUNTRY_SINGAPORE, true);
