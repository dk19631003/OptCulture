...
public List<DRSMSSent> findbyuserId(Long userId){
		List<DRSMSSent> retList = null;
		try {

			String qry=" FROM DRSMSSent WHERE userId ="+userId.longValue()+" AND status ='"+Constants.DR_STATUS_SUBMITTED+"' AND messageId IS NOT NULL ";
			retList =   executeQuery(qry);
