...
public class SMSOpensDao extends AbstractSpringDao{
	 ...
	 public List<Object[]> getOpenRateByCrId(Long crId, String startDateStr, String endDateStr){
	    	...
	    	if(startDateStr==null || endDateStr== null) {
	    		...
	    		return getHibernateTemplate().find( "SELECT SUBSTRING(time(o.openDate),1,2), " +
	    				"COUNT(o.sentId), COUNT(DISTINCT o.sentId) FROM SMSOpens o, SMSCampaignSent cs " +
	    				"WHERE cs.smsCampaignReport="+crId+ " AND " +
	    				"o.sentId = cs.sentId " +
