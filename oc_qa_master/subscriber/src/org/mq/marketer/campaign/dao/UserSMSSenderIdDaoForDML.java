...
public class UserSMSSenderIdDaoForDML extends AbstractSpringDaoForDML {
	...
	public void deleteBySenderId(String senderId,String smsType) throws Exception{
		
		String qry ="DELETE FROM UserSMSSenderId WHERE senderId='"+senderId+"'and smsType='"+smsType+"'";
