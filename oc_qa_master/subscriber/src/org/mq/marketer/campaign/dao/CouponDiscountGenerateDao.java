...
*/		 list = executeQuery(qry);
	...
	/*public CouponDiscountGeneration findCouponsDiscgenById(Long couponId) {

		String query = "FROM CouponDiscountGeneration  WHERE coupons ="+couponId+" ";
		
		List<CouponDiscountGeneration> list = getHibernateTemplate().find(query);
