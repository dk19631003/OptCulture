 ...
 */
	...
	public List< EventTriggerEvents> findStatusPendingReportsNew(Long userId, Long eventTrigId, int start,int end,String fromDate,String toDate,String key, String emailSatusTobeFetched) {
		try {
			List<EventTriggerEvents > list = null;
