...
*/ 
 ...
 public void onClick$saveBtnId(){
	...
	/* String message = "<html><head></head><body><font style=\" font-family: Arial ; font-size: 15; line-height: 150%;word-spacing: normal ;\">"
				...
				+ "<p/>Log-in URL: <a href=\"https://qcapp.optculture.com\">https://qcapp.optculture.com</a><br/>Username : [username]<br />Organization : [organization]<br /><br />"
	...
	*/ 
	 ...
	 //<html><head></head><body><font style="font-family: Arial ; font-size: 15; line-height: 150%;word-spacing: normal;">Hi [fname],<br /><br /><P>We noticed that you recently activated Subscriber Preference Center feature in your OptCulture account. In order for this feature to function properly for currently running email/SMS campaigns and/or Event triggers,please add &#39;Campaign Category&#39; setting to them. </p><br /><p>Following is the list of your actively running email/SMS communication that need this setting:<p/>[Active_CampaignsList_WithOut_Category]<br /><p>Account details:<p/>Log-in URL: <a href="https://qcapp.optculture.com">https://qcapp.optculture.com</a><br/>Username : [username]<br/>Organization : [organization]<br/><br /><p>In case of any queries on this feature or anything else on the application, please reach out to us at <a href="mailto:teamCS@optculture.com">teamCS@optculture.com.</a><p/><br/><br/>Regards,<br />Team OptCulture</font></body></html>
