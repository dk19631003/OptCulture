...
/*	PROFILE_OPTED_IN_DATE(1, 1, "Opted In Date", false, null, "Date", null, null, null, null, "Date(c.created_date)"),
	...
	PROFILE_OPT_IN_MEDIUM(9, 1, "Contact Source", "Contact Source", false, null, "string", null, null, null, null, "c.optin_medium"),
		PROFILE_OPT_IN_MEDIUM_IS(102,0,"is","is","String",PROFILE_OPT_IN_MEDIUM,null,null,null,""),
			...
			//App-3385
			PROFILE_OPT_IN_MEDIUM_IS_NOT(103,0,"is not","is not","String",PROFILE_OPT_IN_MEDIUM,null,null,null,""),
			PROFILE_OPT_IN_MEDIUM_IS_NOT_POS(201,0,"POS","POS", "String", PROFILE_OPT_IN_MEDIUM_IS_NOT, null,null,"is not","", "POS"),
			PROFILE_OPT_IN_MEDIUM_IS_NOT_ONLINE(202,0, "Manual Upload", "Manual Upload", "string", PROFILE_OPT_IN_MEDIUM_IS_NOT, null, null,"not equal", "", "AddedManually" ),
			PROFILE_OPT_IN_MEDIUM_IS_NOT_OFFLINE(203,0, "Web Form", "Web Form", "string", PROFILE_OPT_IN_MEDIUM_IS_NOT, null,  null, "not equals", "", "WebForm" ),
			PROFILE_OPT_IN_MEDIUM_IS_NOT_MOBILE_OPTIN(204,0, "Mobile Opt-In", "Mobile Opt-In", "string", PROFILE_OPT_IN_MEDIUM_IS_NOT, null,  null, "not equal to", "", "Mobile Opt-In" ),
			PROFILE_OPT_IN_MEDIUM_IS_NOT_ECOMMERCE(205,0, "eCommerce", "eCommerce", "string", PROFILE_OPT_IN_MEDIUM_IS_NOT, null,  null, "is not equal", "", "eComm" ),
	...
	PURCHASE_DATE (0, 2, "Purchase Date", "Purchase Date", true, "Sale Date", "Date", null, null, null, null,"Date(sal.sales_date)"),
		...
		PURCHASE_LAST_DATE_EQUAL_TO(501,0, "days since last purchase", "days since last purchase", "number", PURCHASE_DATE, "number", null, "date_diff_equal_to", ""),
			...
			TOTAL_PURCHASE_VALUE_TOTAL_IS_MORE_THAN(101, 0, "Is more than", "Is more than", "number", TOTAL_PURCHASE_VALUE_TOTAL,"double", null, ">",""),
			...
			TOTAL_PURCHASE_VALUE_TOTAL_IS_IN_THE_RANGE(101, 0, "Is in the range of", "Is in the range of", "number", TOTAL_PURCHASE_VALUE_TOTAL,"double", "double", "between",""),
				...
				*/	
				...
				TOTAL_PURCHASE_VALUE_WITHOUT_TAX(10, 2, "Purchase Amount Before Tax", "Total Purchase Amount Before Tax", "number", null, null, null, null, null),
					...
					//APP-1211 - added a new attribute which gives exact quantity from all purchases over the period	
...
PURCHASE_TOTAL_NUMBER_OF_PURCHASES(8, 2, "Number of Purchases", "Total Number of Purchases", "number", null, null, null, null, null),
			...
			PURCHASE_TOTAL_NUMBER_OF_PURCHASES_IN_ALL_PRODUCTS(7, 0, "all", "in all Products", "number", PURCHASE_TOTAL_NUMBER_OF_PURCHASES, null, null, null,"aggr_count", "", "count(totSal.cid) "),
...
PURCHASE_TOTAL_NUMBER_OF_LIFETIME_PURCHASES(18, 2, "Visits till date", "Visits till date", "number", null, null, null, null, null),
		...
		PURCHASE_TOTAL_PURCHASE_VALUE(7, 2, "Single Receipt", "Purchase Amount", "number", null, null, null, null, null),
			...
			PURCHASE_TOTAL_PURCHASE_VALUE_TOTAL_IS_IN_THE_RANGE(101, 0, "Is in the range of", "Is in the range of", "number", PURCHASE_TOTAL_PURCHASE_VALUE_TOTAL,"double", "double", "between",""),
				...
				*/	
				...
				//ISSUANCE_DATE (0, 3, "Issuance Date", "Issuance Date", false, null, "Date", null, null, null, null,"ltytrxch.transaction_type='Issuance' AND Date(ltytrxch.created_date)"),
				//PURCHASE_LOYALTY_GIFT_BALANCE_IS(102, 0, "Balance Amount",true,"Balance Amount", "Number", PURCHASE_LOYALTY_GIFT_BALANCE, null, null, null, "loyalty.gift_balance"),
				...
				/*-----------end-----------*/
				/*ISSUANCE_DATE (0, 3, "Issuance Date",false, "Issuance Date",  "Date", null, null, null, null,"Date(ltytrxch.created_date)"),
				
				ISSUANCE_IS(101, 0, "is", "is", "date", ISSUANCE_DATE, null, null, null, ""),
						ISSUANCE_TO_DAY(102,  0, "Today", "Today", "date", ISSUANCE_IS, null, null, "isToday", ""),
						ISSUANCE_EQUAL_TO(103,  0, "Equal to", "Equal to", "date", ISSUANCE_IS, "Date", null, "is", ""),
						ISSUANCE_BETWEEN(104,  0, "Between", "Between", "date", ISSUANCE_IS, "Date", "Date", "between", ""),
						ISSUANCE_ON_OR_AFTER(105, 0,  "On or after",  "On or after", "date", ISSUANCE_IS, "Date", null, "onOrAfter", ""),
						ISSUANCE_ON_OR_BEFORE(106, 0, "On or before", "On or before", "date", ISSUANCE_IS, "Date", null, "onOrBefore", ""),
						ISSUANCE_AFTER(107, 0, "After", "After", "date", ISSUANCE_IS, "Date", null, "after", ""),
						ISSUANCE_BEFORE(108, 0, "Before", "Before", "date", ISSUANCE_IS, "Date", null, "before", ""),
						
						ISSUANCE_IS_IGNORE_YEAR(101, 0, "is(in range)", "is(in range)", "date", ISSUANCE_DATE, null, null, null, ""),
						ISSUANCE_BEFORE_BETWEEN_DAYS(109,0, "Last Range Of Days", "Last Range Of Days", "date", ISSUANCE_IS_IGNORE_YEAR, "number", "number", "range_between", ""),
						//ISSUANCE_AFTER_BETWEEN_DAYS(110,0, "Next Range Of Days", "date", ISSUANCE_IS_IGNORE_YEAR, "number", "number", "after_between", ""),
						
						
					ISSUANCE_WITH_IN_LAST(201, 0, "within last", "within last", "date", ISSUANCE_DATE, null,null, null, ""),
						ISSUANCE_DAYS(202, 0, "days", "days", "date", ISSUANCE_WITH_IN_LAST, "31", "1", "withinlast_days", ""),
						ISSUANCE_WEEKS(203, 0, "weeks", "weeks", "date", ISSUANCE_WITH_IN_LAST, "4", "7", "withinlast_weeks", ""),
						ISSUANCE_MONTHS(204, 0, "months", "months", "date", ISSUANCE_WITH_IN_LAST, "12", "30", "withinlast_months", ""),
							
					
						
					ISSUANCE_NOT_WITH_IN_LAST(301, 0, "not within last", "not within last","date", ISSUANCE_DATE,null,null, null,""),
					
						ISSUANCE_NOT_DAYS(302, 0, "days", "days", "date", ISSUANCE_NOT_WITH_IN_LAST, "31", "1", "notwithinlast_days", ""),
						ISSUANCE_NOT_WEEKS(303, 0, "weeks", "weeks", "date", ISSUANCE_NOT_WITH_IN_LAST, "4", "7", "notwithinlast_weeks", ""),
						ISSUANCE_NOT_MONTHS(304, 0, "months", "months", "date", ISSUANCE_NOT_WITH_IN_LAST, "12", "30", "notwithinlast_months", ""),
					
					ISSUANCE_IS_NOT(401, 0, "is not", "is not", "date", ISSUANCE_DATE, null,null, null, ""),
						ISSUANCE_NOT_AFTER(402, 0, "after", "after", "date", ISSUANCE_IS_NOT, "date", null, "before", ""),
						ISSUANCE_NOT_BRFORE(403, 0, "before", "before", "date", ISSUANCE_IS_NOT, "date", null, "after", ""),

					ISSUANCE_AMOUNT(10, 3, "Issuance Amount",false, "Total Issuance Amount", "number", null, null, null, null, null),
						
						
						ISSUANCE_AMOUNT_TOTAL(10, 0, "Total", "Total", "number", ISSUANCE_AMOUNT , null, null, null, "aggrlty_totissued", "", "sum(totloyal.totissuedAmt) "),
						ISSUANCE_AMOUNT_TOTAL_IS_MORE_THAN(101, 0, "Is more than", "Is more than", "number", ISSUANCE_AMOUNT_TOTAL,"double", null, ">",""),
						ISSUANCE_AMOUNT_TOTAL_IS_LESS_THEN(102, 0, "Is less than", "Is less than", "number", ISSUANCE_AMOUNT_TOTAL,"double", null, "<",""),
						ISSUANCE_AMOUNT_TOTAL_IS_IN_THE_RANGE(101, 0, "Is in the range of", "Is in the range of", "number", ISSUANCE_AMOUNT_TOTAL,"double", "double", "between",""),
						

							PURCHASE_ISSUANCE_AMOUNT_AVG(7, 0, "Avg", "number", PURCHASE_ISSUANCE_AMOUNT , null, null, null, "aggr.avg_purchase_amt"),
								PURCHASE_ISSUANCE_AMOUNT_AVG_IS_MORE_THAN(101, 0, "Is more than", "number", PURCHASE_ISSUANCE_AMOUNT_AVG,"double", null, ">",""),
								PURCHASE_ISSUANCE_AMOUNT_AVG_IS_LESS_THEN(102, 0, "Is less than", "number", PURCHASE_ISSUANCE_AMOUNT_AVG,"double", null, "<",""),
								PURCHASE_ISSUANCE_AMOUNT_AVG_IS_IN_THE_RANGE(101, 0, "Is in the range of", "number", PURCHASE_ISSUANCE_AMOUNT_AVG,"double", "double", "between",""),
								
							ISSUANCE_AMOUNT_AVG(10, 0, "Average of all", "Average of all", "number", ISSUANCE_AMOUNT , null, null, null, "aggrlty_avgissued", "", "(sum(totloyal.totissuedAmt)/count(totloyal.loyalty_id)) "),
								ISSUANCE_AMOUNT_AVG_IS_MORE_THAN(101, 0, "Is more than", "Is more than", "number", ISSUANCE_AMOUNT_AVG,"double", null, ">",""),
								ISSUANCE_AMOUNT_AVG_IS_LESS_THEN(102, 0, "Is less than", "Is less than", "number", ISSUANCE_AMOUNT_AVG,"double", null, "<",""),
								ISSUANCE_AMOUNT_AVG_IS_IN_THE_RANGE(101, 0, "Is in the range of", "Is in the range of", "number", ISSUANCE_AMOUNT_AVG,"double", "double", "between",""),
								
								
								
								
							ISSUANCE_AMOUNT_MAX(10, 0, "Maximum of all", "Maximum of all", "number", ISSUANCE_AMOUNT , null, null, null,"aggrlty_maxissued", "",  "max(totloyal.totissuedAmt) "),
								ISSUANCE_AMOUNT_MAX_IS_MORE_THAN(101, 0, "Is more than", "Is more than", "number", ISSUANCE_AMOUNT_MAX,"double", null, ">",""),
								ISSUANCE_AMOUNT_MAX_IS_LESS_THEN(102, 0, "Is less than", "Is less than", "number", ISSUANCE_AMOUNT_MAX,"double", null, "<",""),
								ISSUANCE_AMOUNT_MAX_IS_IN_THE_RANGE(101, 0, "Is in the range of", "Is in the range of", "number", ISSUANCE_AMOUNT_MAX,"double", "double", "between",""),
							
								TOTAL_NUMBER_OF_ISSUANCES(8, 3, "Number of Issuances", "Total Number of Issuances", "number", null, null, null, null, null),
								TOTAL_NUMBER_OF_ISSUANCES_IN_ALL_PRODUCTS(7, 0, "all", "in all Products", "number", TOTAL_NUMBER_OF_ISSUANCES, null, null, null,"aggrlty_issuancecount", "", " count(totloyal.loyalty_id) "),
									TOTAL_NUMBER_OF_ISSUANCES_IS_MORE_THAN(101, 0, "Is more than", "Is more than", "number", TOTAL_NUMBER_OF_ISSUANCES,"double", null, ">",""),
									TOTAL_NUMBER_OF_ISSUANCES_IS_LESS_THEN(102, 0, "Is less than", "Is less than", "number", TOTAL_NUMBER_OF_ISSUANCES,"double", null, "<",""),
									TOTAL_NUMBER_OF_ISSUANCES_IS_IN_THE_RANGE(101, 0, "Is in the range of", "Is in the range of", "number", TOTAL_NUMBER_OF_ISSUANCES,"double", "double", "between",""),
	
				
						//Redemption_DATE (0, 3, "Redemption Date", "Redemption Date", false, null, "Date", null, null, null, null,"ltytrxch.transaction_type='Redemption' AND Date(ltytrxch.created_date) "),
						Redemption_DATE (0, 3, "Redemption Date",false, "Redemption Date", "Date", null, null, null, null,"Date(ltytrxch.created_date) "),
						
						
						Redemption_IS(101, 0, "is", "is", "date", Redemption_DATE, null, null, null, ""),
								Redemption_TO_DAY(102,  0, "Today", "Today", "date", Redemption_IS, null, null, "isToday", ""),
								Redemption_EQUAL_TO(103,  0, "Equal to", "Equal to", "date", Redemption_IS, "Date", null, "is", ""),
								Redemption_BETWEEN(104,  0, "Between", "Between", "date", Redemption_IS, "Date", "Date", "between", ""),
								Redemption_ON_OR_AFTER(105, 0,  "On or after",  "On or after", "date", Redemption_IS, "Date", null, "onOrAfter", ""),
								Redemption_ON_OR_BEFORE(106, 0, "On or before", "On or before", "date", Redemption_IS, "Date", null, "onOrBefore", ""),
								Redemption_AFTER(107, 0, "After", "After", "date", Redemption_IS, "Date", null, "after", ""),
								Redemption_BEFORE(108, 0, "Before", "Before", "date", Redemption_IS, "Date", null, "before", ""),
								
								Redemption_IS_IGNORE_YEAR(101, 0, "is(in range)", "is(in range)", "date", Redemption_DATE, null, null, null, ""),
								Redemption_BEFORE_BETWEEN_DAYS(109,0, "Last Range Of Days", "Last Range Of Days", "date", Redemption_IS_IGNORE_YEAR, "number", "number", "range_between", ""),
								//Redemption_AFTER_BETWEEN_DAYS(110,0, "Next Range Of Days", "date", Redemption_IS_IGNORE_YEAR, "number", "number", "after_between", ""),
								
								
							Redemption_WITH_IN_LAST(201, 0, "within last", "within last", "date", Redemption_DATE, null,null, null, ""),
								Redemption_DAYS(202, 0, "days", "days", "date", Redemption_WITH_IN_LAST, "31", "1", "withinlast_days", ""),
								Redemption_WEEKS(203, 0, "weeks", "weeks", "date", Redemption_WITH_IN_LAST, "4", "7", "withinlast_weeks", ""),
								Redemption_MONTHS(204, 0, "months", "months", "date", Redemption_WITH_IN_LAST, "12", "30", "withinlast_months", ""),
									
							
								
							Redemption_NOT_WITH_IN_LAST(301, 0, "not within last", "not within last","date", Redemption_DATE,null,null, null,""),
							
								Redemption_NOT_DAYS(302, 0, "days", "days", "date", Redemption_NOT_WITH_IN_LAST, "31", "1", "notwithinlast_days", ""),
								Redemption_NOT_WEEKS(303, 0, "weeks", "weeks", "date", Redemption_NOT_WITH_IN_LAST, "4", "7", "notwithinlast_weeks", ""),
								Redemption_NOT_MONTHS(304, 0, "months", "months", "date", Redemption_NOT_WITH_IN_LAST, "12", "30", "notwithinlast_months", ""),
							
							Redemption_IS_NOT(401, 0, "is not", "is not", "date", Redemption_DATE, null,null, null, ""),
								Redemption_NOT_AFTER(402, 0, "after", "after", "date", Redemption_IS_NOT, "date", null, "before", ""),
								Redemption_NOT_BRFORE(403, 0, "before", "before", "date", Redemption_IS_NOT, "date", null, "after", ""),
								
						
								REDEMPTION_AMOUNT(10, 3, "Redemption Amount", false, "Total Redemption Amount", "number", null, null, null, null, null),
								
								
								REDEMPTION_AMOUNT_TOTAL(10, 0, "Total", "Total", "number", REDEMPTION_AMOUNT , null, null, null, "aggrlty_totredeemed", "", "sum(totloyal.totredeemedAmt) "),
								OTAL_PURCHASE_VALUE_TOTAL_IS_MORE_THAN(101, 0, "Is more than", "Is more than", "number", REDEMPTION_AMOUNT_TOTAL,"double", null, ">",""),
								REDEMPTION_AMOUNT_TOTAL_IS_LESS_THEN(102, 0, "Is less than", "Is less than", "number", REDEMPTION_AMOUNT_TOTAL,"double", null, "<",""),
								REDEMPTION_AMOUNT_TOTAL_IS_IN_THE_RANGE(101, 0, "Is in the range of", "Is in the range of", "number", REDEMPTION_AMOUNT_TOTAL,"double", "double", "between",""),
								

									PURCHASE_REDEMPTION_AMOUNT_AVG(7, 0, "Avg", "number", PURCHASE_REDEMPTION_AMOUNT , null, null, null, "aggr.avg_purchase_amt"),
										PURCHASE_REDEMPTION_AMOUNT_AVG_IS_MORE_THAN(101, 0, "Is more than", "number", PURCHASE_REDEMPTION_AMOUNT_AVG,"double", null, ">",""),
										PURCHASE_REDEMPTION_AMOUNT_AVG_IS_LESS_THEN(102, 0, "Is less than", "number", PURCHASE_REDEMPTION_AMOUNT_AVG,"double", null, "<",""),
										PURCHASE_REDEMPTION_AMOUNT_AVG_IS_IN_THE_RANGE(101, 0, "Is in the range of", "number", PURCHASE_REDEMPTION_AMOUNT_AVG,"double", "double", "between",""),
										
									REDEMPTION_AMOUNT_AVG(10, 0, "Average of all", "Average of all", "number", REDEMPTION_AMOUNT , null, null, null, "aggrlty_avgredeemed", "", "(sum(totloyal.totredeemedAmt)/count(totloyal.loyalty_id)) "),
										REDEMPTION_AMOUNT_AVG_IS_MORE_THAN(101, 0, "Is more than", "Is more than", "number", REDEMPTION_AMOUNT_AVG,"double", null, ">",""),
										REDEMPTION_AMOUNT_AVG_IS_LESS_THEN(102, 0, "Is less than", "Is less than", "number", REDEMPTION_AMOUNT_AVG,"double", null, "<",""),
										REDEMPTION_AMOUNT_AVG_IS_IN_THE_RANGE(101, 0, "Is in the range of", "Is in the range of", "number", REDEMPTION_AMOUNT_AVG,"double", "double", "between",""),
										
									REDEMPTION_AMOUNT_MAX(10, 0, "Maximum of all", "Maximum of all", "number", REDEMPTION_AMOUNT , null, null, null,"aggrlty_maxredeemed", "",  "max(totloyal.totredeemedAmt) "),
										REDEMPTION_AMOUNT_MAX_IS_MORE_THAN(101, 0, "Is more than", "Is more than", "number", REDEMPTION_AMOUNT_MAX,"double", null, ">",""),
										REDEMPTION_AMOUNT_MAX_IS_LESS_THEN(102, 0, "Is less than", "Is less than", "number", REDEMPTION_AMOUNT_MAX,"double", null, "<",""),
										REDEMPTION_AMOUNT_MAX_IS_IN_THE_RANGE(101, 0, "Is in the range of", "Is in the range of", "number", REDEMPTION_AMOUNT_MAX,"double", "double", "between",""),
										
										TOTAL_NUMBER_OF_REDEMPTIONS(8, 3, "Number of Redemptions",false, "Total Number of Redemptions", "number", null, null, null, null, null),
										TOTAL_NUMBER_OF_REDEMPTIONS_IN_ALL_PRODUCTS(7, 0, "all", "in all Products", "number", TOTAL_NUMBER_OF_REDEMPTIONS, null, null, null,"aggrlty_redemptioncount", "", " count(totloyal.loyalty_id) "),
										TOTAL_NUMBER_OF_REDEMPTION_IS_MORE_THAN(101, 0, "Is more than", "Is more than", "number", TOTAL_NUMBER_OF_REDEMPTIONS,"double", null, ">",""),
										TOTAL_NUMBER_OF_REDEMPTION_IS_LESS_THEN(102, 0, "Is less than", "Is less than", "number", TOTAL_NUMBER_OF_REDEMPTIONS,"double", null, "<",""),
										TOTAL_NUMBER_OF_REDEMPTION_IS_IN_THE_RANGE(101, 0, "Is in the range of", "Is in the range of", "number", TOTAL_NUMBER_OF_REDEMPTIONS,"double", "double", "between",""),
								LOYALTY_STORE_NUMBER(4, 3, "Loyalty Store", false,"Store Number", "String", null, null, null, null, "ltytrxch.store_number"),
								LOYALTY_STORE_EQUALS(101, 0, "Equals", "Equals", "String", LOYALTY_STORE_NUMBER, "text", null, "is", ""),
								LOYALTY_STORE_DOES_NOT_EQUAL(3, 0, "Doesn't equal", "Doesn't equal", "String", LOYALTY_STORE_NUMBER, "text", null, "is not", ""),
								LOYALTY_STORE_ONE_OF(3, 0, "One of", "One of", "String", LOYALTY_STORE_NUMBER, "text", null, "is in", ""),*/
	...
	PURCHASE_ITEM_CATEGORY(2, 2, "Item Category", "Item Category", true, "Item Category", "string", null, null, null ,null, "sku.item_category"),
		...
		//APP-3619
		PURCHASE_LIST_PRICE(4, 2, "List Price", "List Price", true, "List Price", "number", null, null, null, null, "sku.list_price"),			
			PURCHASE_LIST_PRICE_IS_EQUAL_TO(101, 0, "Equal to", "Equal to", "number", PURCHASE_LIST_PRICE,"double", null, "=",""),	
			PURCHASE_LIST_PRICE_IS_MORE_THAN(101, 0, "Is more than", "Is more than", "number", PURCHASE_LIST_PRICE,"double", null, ">",""),
			PURCHASE_LIST_PRICE_IS_LESS_THEN(102, 0, "Is less than", "Is less than", "number", PURCHASE_LIST_PRICE,"double", null, "<",""),
			PURCHASE_LIST_PRICE_IS_IN_THE_RANGE(101, 0, "Is in the range of", "Is in the range of", "number", PURCHASE_LIST_PRICE,"double", "double", "between",""),
		//app-3827
		PURCHASE_ITEM_SALE_PRICE(4, 2, "Item Sale Price", "Item Sale Price", true, "Item Sale Price", "number", null, null, null, null, "ROUND((sal.quantity*sal.sales_price)+sal.tax-(IF(sal.discount is null,0,sal.discount)),2)"),			
			PURCHASE_ITEM_SALE_PRICE_IS_EQUAL_TO(101, 0, "Equal to", "Equal to", "number", PURCHASE_ITEM_SALE_PRICE,"double", null, "=",""),	
			PURCHASE_ITEM_SALE_PRICE_IS_MORE_THAN(101, 0, "Is more than", "Is more than", "number", PURCHASE_ITEM_SALE_PRICE,"double", null, ">",""),
			PURCHASE_ITEM_SALE_PRICE_IS_LESS_THEN(102, 0, "Is less than", "Is less than", "number", PURCHASE_ITEM_SALE_PRICE,"double", null, "<",""),
			PURCHASE_ITEM_SALE_PRICE_IS_IN_THE_RANGE(101, 0, "Is in the range of", "Is in the range of", "number", PURCHASE_ITEM_SALE_PRICE,"double", "double", "between",""),

			
		// promotion rules
				 PROMO_OPTCULTURE_PROMOTION_NAME(17, 4, "OptCulture Discount Name", "OptCulture Promotion Name", "String", null, "text", null, null,"cp.coupon_id::cd.coupon_id"),
				      PROMO_OPTCULTURE_NAME(101,0,"is","is","String",PROMO_OPTCULTURE_PROMOTION_NAME,"text",null,"is",""), 
				
				    
				      PROMO_CODE_PROMO_STATUS(18, 2, "Discount-code Status", "Promo-code Status", "String", null, null, null, null, ""),
				      PROMO_OPTCULTURE_CONTACT_HAVE(101,0,"have","have","String",PROMO_CODE_PROMO_STATUS,null,null,"",""),
				         PROMO_OPTCULTURE_CONTACT_ISSUED(201,0,"Issued Discount Code","Issued Promo Code","String",PROMO_OPTCULTURE_CONTACT_HAVE,null,null,"is value","cd.status"," IN('Active','Redeemed')"), 
				         PROMO_OPTCULTURE_CONTACT_REDEEMED(202,0,"Redeemed Discount Code","Redeemed Promo Code","String",PROMO_OPTCULTURE_CONTACT_HAVE,null,null,"is in redeem","cd.status","Redeemed"),
				      PROMO_OPTCULTURE_CONTACT_HAVE_NOT(102,0,"have not","have not","String",PROMO_CODE_PROMO_STATUS,null,null,"!=",""),
				        PROMO_OPTCULTURE_CONTACT_ISSUED_NOT(201,0,"Issued Discount Code","Issued Promo Code","String",PROMO_OPTCULTURE_CONTACT_HAVE_NOT,null,null,"is not in active","cd.status","notactive"), 
				        PROMO_OPTCULTURE_CONTACT_REDEEMED_NOT(202,0,"Redeemed Discount Code","Redeemed Promo Code","String",PROMO_OPTCULTURE_CONTACT_HAVE_NOT,null,null,"is not in redeem","cd.status","Active"),
				     
				  
				     
				    PROMO_CODE_DATE_STATUS (19, 2, "Discount-code Date", "Promo-code Date",  "Date", null, null, null, null,""),
	...
	PURCHASE_TOTAL_LOYALTY_POINTS(10, 2, "Total Reward Points", "number",null, null, null, null, "total.rewardPoints"),	
		...
		*/
	PURCHASE_PROMO(3, 2, "Store Discount Code", "Promo", true, "Promo Code", "String", null, null, null, null, "sal.promo_code"),
	...
	PURCHASE_TENDER_TYPE(9, 2, "Tender Type", "Tender Type", true, "Tender Type", "String", null, null, null, null, "sal.tender_type"),
		PURCHASE_TENDER_TYPE_IS(101, 0, "is", "is", "String", PURCHASE_TENDER_TYPE, null, null, null, ""),
			...
			PURCHASE_TENDER_IS_CHARGE(209, 0, "Charge", "Charge", "String", PURCHASE_TENDER_TYPE_IS, null, null, "equals", "Charge"),
			PURCHASE_TENDER_IS_STORE_CREDIT(210, 0, "Store Credit", "Store Credit", "String", PURCHASE_TENDER_TYPE_IS, null, null, "equal to", "Store Credit"),
			PURCHASE_TENDER_IS_COD(211, 0, "COD", "COD", "String", PURCHASE_TENDER_TYPE_IS, null, null, "equals", "COD"),
			PURCHASE_TENDER_IS_OTHER(212,0, "Other", "Other", "String", PURCHASE_TENDER_TYPE_IS, "text", null, "is equals to", ""),//app-3505
			
		PURCHASE_TENDER_TYPE_IS_NOT_EQUAL_TO(102, 0, "is not", "is", "String", PURCHASE_TENDER_TYPE, null, null, null, ""),
			PURCHASE_TENDER_IS_NOT_EQUAL_TO_CASH(201, 0, "Cash", "Cash", "String", PURCHASE_TENDER_TYPE_IS_NOT_EQUAL_TO, null, null, "is not", "", "Cash"),
			PURCHASE_TENDER_IS_NOT_EQUAL_TO_CREDIT_CARD(202, 0, "Credit Card", "Credit Card", "String", PURCHASE_TENDER_TYPE_IS_NOT_EQUAL_TO, null, null, "is not", "", "CC"),
			PURCHASE_TENDER_IS_NOT_EQUAL_TO_GIFT_CERTIFICATE(205, 0, "Gift Certificate", "Gift Certificate", "String", PURCHASE_TENDER_TYPE_IS_NOT_EQUAL_TO, null, null, "is not", "Gift Certificate"),
			PURCHASE_TENDER_IS_NOT_EQUAL_TO_CHECK(207, 0, "Check", "Check", "String", PURCHASE_TENDER_TYPE_IS_NOT_EQUAL_TO, null, null, "is not", "Check"),
			PURCHASE_TENDER_IS_NOT_EQUAL_TO_CHARGE(209, 0, "Charge", "Charge", "String", PURCHASE_TENDER_TYPE_IS_NOT_EQUAL_TO, null, null, "is not", "Charge"),
			PURCHASE_TENDER_IS_NOT_EQUAL_TO_STORE_CREDIT(210, 0, "Store Credit", "Store Credit", "String", PURCHASE_TENDER_TYPE_IS_NOT_EQUAL_TO, null, null, "is not", "Store Credit"),
			PURCHASE_TENDER_IS_NOT_EQUAL_TO_COD(211, 0, "COD", "COD", "String", PURCHASE_TENDER_TYPE_IS_NOT_EQUAL_TO, null, null, "is not", "COD"),
			PURCHASE_TENDER_IS_NOT_EQUAL_TO_DEBIT_CARD(203, 0, "Debit Card", "Debit Card", "String", PURCHASE_TENDER_TYPE_IS_NOT_EQUAL_TO, null, null, "is not", "Debit Card"),
			PURCHASE_TENDER_IS_NOT_EQUAL_TO_GIFT_CARD(204, 0, "Gift Card", "Gift Card", "String", PURCHASE_TENDER_TYPE_IS_NOT_EQUAL_TO, null, null, "is not", "Gift Card"),
			PURCHASE_TENDER_IS_NOT_EQUAL_TO_TRAVELLERS_CHECK(206, 0, "Travelers Check", "Travelers Check", "String", PURCHASE_TENDER_TYPE_IS_NOT_EQUAL_TO, null, null, "is not", "Travelers Check"),
			PURCHASE_TENDER_IS_NOT_EQUAL_TO_OTHER(207,0, "Other", "Other", "string", PURCHASE_TENDER_TYPE_IS_NOT_EQUAL_TO, "text", null, "is not equal", ""),//app-3505

			//PURCHASE_TENDER_IS_NOT_EQUAL_TO_DISNEY_MATRA_HOTEL(208, 0, "Disney Matra/Hotel", "Disney Matra/Hotel", "String", PURCHASE_TENDER_TYPE_IS_NOT_EQUAL_TO, null, null, "is not", "Disney Matra/Hotel"),
	...
	/*//earned loyalty new		
			...
			PURCHASE_LOYALTY_TOTAL_ISSUED_IS(101, 0, "Total Issued", "Total Issued", "Number", PURCHASE_LOYALTY_BALANCE, null, null, null, "loyalty.total_loyalty_earned"),
			PURCHASE_LOYALTY_BALANCE_IS(103, 0, "Balance", "Balance", "Number", PURCHASE_LOYALTY_BALANCE, null, null, null, "loyalty.loyalty_balance"),
				
			PURCHASE_LOYALTY_POINTS_IS(1, 0, "Points", "Points", "Number", PURCHASE_LOYALTY_TOTAL_ISSUED_IS, null, null, null, ""),
			PURCHASE_LOYALTY_TOTAL_USD_IS(102, 0, "Amount", "Amount", "Number", PURCHASE_LOYALTY_TOTAL_ISSUED_IS, null, null, null, "loyalty.total_giftcard_amount"),
			...
			PURCHASE_LOYALTY_BALANCE_POINTS_IS_MORE_THAN(101, 0, "More than", "More than", "number", PURCHASE_LOYALTY_TOTAL_USD_IS,"double", null, ">",""),
				PURCHASE_LOYALTY_BALANCE_POINTS_IS_LESS_THAN(101, 0, "Less than", "Less than", "number", PURCHASE_LOYALTY_TOTAL_USD_IS,"double", null, "<",""),
				PURCHASE_LOYALTY_BALANCE_POINTS_IS_EQUAL_TO(101, 0, "Equal to", "Equal to", "number", PURCHASE_LOYALTY_TOTAL_USD_IS,"double", null, "=",""),
				PURCHASE_LOYALTY_BALANCE_POINTS_IS_BETWEEN(101, 0, "Between", "Between", "number", PURCHASE_LOYALTY_TOTAL_USD_IS,"double", "double", "between",""),
				PURCHASE_LOYALTY_BALANCE_POINTS_IS_NO_VALUE(101, 0, "Empty", "Empty", "number", PURCHASE_LOYALTY_TOTAL_USD_IS, null, null, "none","", " IS NULL OR loyalty.loyalty_balance=0"),*/
			/*PURCHASE_LOYALTY_TOTAL_USD_IS_MORE_THAN(102, 0, "More than", "More than", "number", PURCHASE_LOYALTY_BALANCE_IS,"double", null, ">",""),
				PURCHASE_LOYALTY_TOTAL_USD_IS_LESS_THAN(102, 0, "Less than", "Less than", "number", PURCHASE_LOYALTY_BALANCE_IS,"double", null, "<",""),
				PURCHASE_LOYALTY_TOTAL_USD_IS_EQUAL_TO(102, 0, "Equal to", "Equal to", "number", PURCHASE_LOYALTY_BALANCE_IS,"double", null, "=",""),
				PURCHASE_LOYALTY_TOTAL_USD_IS_BETWEEN(102, 0, "Between", "Between", "number", PURCHASE_LOYALTY_BALANCE_IS,"double", "double", "between",""),
				PURCHASE_LOYALTY_TOTAL_USD_IS_NO_VALUE(102, 0, "Empty", "Empty", "number", PURCHASE_LOYALTY_BALANCE_IS, null, null, "none","", " IS NULL OR loyalty.total_giftcard_amount=0"),*/
				
				/*PURCHASE_LOYALTY_BALANCE_USD_IS_MORE_THAN(102, 0, "More than", "More than", "number", PURCHASE_LOYALTY_BALANCE_IS,"double", null, ">",""),
				PURCHASE_LOYALTY_BALANCE_USD_IS_LESS_THAN(102, 0, "Less than", "Less than", "number", PURCHASE_LOYALTY_BALANCE_IS,"double", null, "<",""),
				PURCHASE_LOYALTY_BALANCE_USD_IS_EQUAL_TO(102, 0, "Equal to", "Equal to", "number", PURCHASE_LOYALTY_BALANCE_IS,"double", null, "=",""),
				PURCHASE_LOYALTY_BALANCE_USD_IS_BETWEEN(102, 0, "Between", "Between", "number", PURCHASE_LOYALTY_BALANCE_IS,"double", "double", "between",""),
				PURCHASE_LOYALTY_BALANCE_USD_IS_NO_VALUE(102, 0, "Empty", "Empty", "number", PURCHASE_LOYALTY_BALANCE_IS, null, null, "none","", " IS NULL OR loyalty.giftcard_balance=0"),
				//value codes
				PURCHASE_LOYALTY_TOTAL_USD_IS(102, 0, "Total Amount", "Total Amount", "Number", PURCHASE_LOYALTY_BALANCE, null, null, null, "loyalty.total_giftcard_amount"),
				PURCHASE_LOYALTY_TOTAL_USD_IS_MORE_THAN(102, 0, "More than", "More than", "number", PURCHASE_LOYALTY_TOTAL_USD_IS,"double", null, ">",""),
				PURCHASE_LOYALTY_TOTAL_USD_IS_LESS_THAN(102, 0, "Less than", "Less than", "number", PURCHASE_LOYALTY_TOTAL_USD_IS,"double", null, "<",""),
	...
	PURCHASE_LOYALTY_OPT_IN_MEDIUM(14, 1, "Loyalty Opt-in Source", "Loyalty Opt-in Medium", "string", null, null, null, null, "loyalty.contact_loyalty_type"),
		PURCHASE_LOYALTY_OPT_IN_MEDIUM_IS(102,0,"is","is","String",PURCHASE_LOYALTY_OPT_IN_MEDIUM,null,null,null,""),
			...
			PURCHASE_LOYALTY_OPT_IN_MEDIUM_IS_ECOMM(204,0, "eCommerce", "eCommerce", "string", PURCHASE_LOYALTY_OPT_IN_MEDIUM_IS, null,  null, "equals", "", "eComm" ),
