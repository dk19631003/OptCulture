...
public class LoyaltyCardSet {
	...
	private String generationType;// Random/Sequential
	...
	private char migratedFlag; // Y/N migrated from SB or other party card-sets or generated at OC
	private String cardSetType;// Physical/Virtual
	private int linkedTierLevel;
	private String cardGenerationType; // System/Custom/Dynamic
	...
	public String getCardGenerationType() {
		return cardGenerationType;
	}

	public void setCardGenerationType(String cardGenerationType) {
		this.cardGenerationType = cardGenerationType;
	}
