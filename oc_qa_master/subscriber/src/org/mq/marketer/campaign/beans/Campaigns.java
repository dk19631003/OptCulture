...
public class Campaigns implements java.io.Serializable {
	...
	private static final Logger logger = LogManager.getLogger(Constants.SUBSCRIBER_LOGGER);
     ...
     //For Bee editor only reload if we give json
	...
	private String scheduleType;
     ...
     private Calendar statusChangedOn;
     private boolean downloadPdf;
     
     private String alignmentFlag;
     
    //APP 4123 
    private boolean hasPreviewText;
	private String previewText;

    
    public boolean isHasPreviewText() {
		return hasPreviewText;
	}

	public void setHasPreviewText(boolean hasPreviewText) {
		this.hasPreviewText = hasPreviewText;
	}
	...
	public void setPreviewText(String previewText) {
		this.previewText = previewText;
      	 ...
      	 public String getAlignmentFlag() {
 		return alignmentFlag;
 	}

 	public void setAlignmentFlag(String alignmentFlag) {
	...
	public void setStatusChangedOn(Calendar statusChangedOn) {
	...
	public Campaigns getCopy() {
		Campaigns newCampaign = new Campaigns();
		newCampaign.setCampaignName(this.campaignName);
		newCampaign.setLabel(this.label);
		newCampaign.setSubject(this.subject);
		newCampaign.setFromName(this.fromName);
		newCampaign.setFromEmail(this.fromEmail);
		newCampaign.setReplyEmail(this.replyEmail);
		newCampaign.setCompanyName(this.companyName);
		...
		newCampaign.setEditorType(this.editorType);
		newCampaign.setContentType(this.contentType);
		newCampaign.setListsType(this.listsType);
		newCampaign.setPlaceHoldersType(this.placeHoldersType);
		newCampaign.setHtmlText(this.htmlText);
		//bee editor
		newCampaign.setJsonContent(this.jsonContent);
		
		
		//newCampaign.setConfiguredPhValStr(this.configuredPhValStr);
		newCampaign.setFinalHtmlText(this.finalHtmlText);
		newCampaign.setPrepared(false);
		newCampaign.setTextMessage(this.textMessage);
		newCampaign.setCouponFlag(this.couponFlag);
		newCampaign.setWebLinkFlag(this.webLinkFlag);
		newCampaign.setWebLinkText(this.webLinkText);
		newCampaign.setWebLinkUrlText(this.webLinkUrlText);
		newCampaign.setPermissionRemainderFlag(this.permissionRemainderFlag);
		newCampaign.setPermissionRemainderText(this.permissionRemainderText);
		newCampaign.setAddressFlag(this.addressFlag);
		newCampaign.setAddressStr(this.addressStr);
//		newCampaign.setAddress(this.address);
		newCampaign.setAddrsType(this.addrsType);
		newCampaign.setIncludeBeforeStr(this.includeBeforeStr);
		newCampaign.setCategoryWeight(this.categoryWeight);
//		newCampaign.setSelectedDates(this.selectedDates);
		newCampaign.setUsers(this.users);
		newCampaign.setTemplate(this.template);
		newCampaign.setPersonalizeTo(this.personalizeTo);
		newCampaign.setToName(this.toName);
		newCampaign.setCategories(this.categories);
		Set<MailingList> newMlSet = new HashSet();
		for (MailingList ml : this.mailingLists) {
			newMlSet.add(ml);
		}
		newCampaign.setMailingLists(newMlSet);
		newCampaign.setAlignmentFlag(this.alignmentFlag);
		newCampaign.setHasPreviewText(this.hasPreviewText);
		newCampaign.setPreviewText(this.previewText);
		return newCampaign;
	}
