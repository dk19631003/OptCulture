...
public class ProgramOnlineReports implements Serializable{
	...
	public ProgramOnlineReports(ComponentsAndContacts compContactsId, 
			String componentWinId, Date activityDate, Long programId, Long componentId, Long contactId) {
