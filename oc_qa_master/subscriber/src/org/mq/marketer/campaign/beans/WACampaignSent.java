...
public class WACampaignSent implements java.io.Serializable{
...
public WACampaignSent() {
   ...
   public WACampaignSent(String mobileNumber, WACampaignReport waCampaignReport, String status, Long contactId) {
       this.mobileNumber = mobileNumber;
       this.waCampaignReport = waCampaignReport;
       this.status = status;
       this.contactId = contactId;
