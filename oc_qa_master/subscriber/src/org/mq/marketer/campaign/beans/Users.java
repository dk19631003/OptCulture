...
public class Users  implements java.io.Serializable, Comparable<Users> {
	...
	private boolean giftCardProgram;
	...
	public boolean isGiftCardProgram() {
		return giftCardProgram;
	}

	public void setGiftCardProgram(boolean giftCardProgram) {
	...
	public void setQRCodeHTMLTemplate(String qRCodeHTMLTemplate) {
		QRCodeHTMLTemplate = qRCodeHTMLTemplate;
	}

	public String getQRCodeToURL() {
		return QRCodeToURL;
	}

	public void setQRCodeToURL(String qRCodeToURL) {
		QRCodeToURL = qRCodeToURL;
	}

	public String getOneQRCodeHtml() {
		return OneQRCodeHtml;
	}

	public void setOneQRCodeHtml(String oneQRCodeHtml) {
		OneQRCodeHtml = oneQRCodeHtml;
	}
	...
	private String  QRCodeToURL;
	  private String OneQRCodeHtml;
