...
public class SMSCampaignSent implements java.io.Serializable{
...
public SMSCampaignSent() {
   ...
   public SMSCampaignSent(String mobileNumber, SMSCampaignReport smsCampaignReport, String status, Long contactId) {
