...
public class Receipt {
	...
	//APP-4195
	private String CNI_No;
	
	public String getCNI_No() {
		return CNI_No;
	}
	public void setCNI_No(String CNI_No) {
		this.CNI_No = CNI_No;
	}
	...
	public String getStoreGSTNumber() {
		return StoreGSTNumber;
	}
	public void setStoreGSTNumber(String storeGSTNumber) {
	...
	private String AvgDiscountFactor;//APP-4663
	public String getAvgDiscountFactor() {
		return AvgDiscountFactor;
	}
	public void setAvgDiscountFactor(String avgDiscountFactor) {
		AvgDiscountFactor = avgDiscountFactor;
	}
	private String CustomerGSTNumber; //added for app-3652
