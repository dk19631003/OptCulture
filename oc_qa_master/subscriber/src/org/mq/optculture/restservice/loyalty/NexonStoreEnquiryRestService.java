...
public class NexonStoreEnquiryRestService extends AbstractController {
	...
	protected ModelAndView handleRequestInternal(HttpServletRequest request,
		...
		try {
			logger.info("nexon store enq request calling >>>> : ");
			...
			baseRequestObject.setAction(OCConstants.NEXON_REST_SERVICE_REQUEST);
			baseService = ServiceLocator.getInstance().getServiceByName(OCConstants.NEXON_STORE_ENQUIRY_BUSINESS_SERVICE);
