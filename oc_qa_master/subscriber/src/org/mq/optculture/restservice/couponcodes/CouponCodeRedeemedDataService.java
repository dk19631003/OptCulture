...
public class CouponCodeRedeemedDataService extends AbstractController {
	...
	public PromoTrxLog logTransactionRequest(CouponCodeRedeemReq requestObject, String jsonRequest, String mode){
		...
		try {
			...
			//APP-4766
			if(requestObject.getPURCHASECOUPONINFO().getTYPE()!=null && !requestObject.getPURCHASECOUPONINFO().getTYPE().isEmpty() 
					&& requestObject.getPURCHASECOUPONINFO().getTYPE().equalsIgnoreCase("Void"))
				transaction.setType("VoidEnrolment");
			else
