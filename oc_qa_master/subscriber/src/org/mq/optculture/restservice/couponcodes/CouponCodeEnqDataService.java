...
public class CouponCodeEnqDataService extends AbstractController{
	...
	protected ModelAndView handleRequestInternal(HttpServletRequest request,
		...
		try {
			logger.info("enquiry request calling here >>>> : ");
			...
			baseRequestObject.setAction(OCConstants.COUPON_CODE_ENQUIRY_REQUEST);
			baseService = ServiceLocator.getInstance().getServiceByName(OCConstants.COUPON_CODE_ENQUIRY_BUSINESS_SERVICE);
