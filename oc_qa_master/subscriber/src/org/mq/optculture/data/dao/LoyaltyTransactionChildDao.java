...
public class LoyaltyTransactionChildDao extends AbstractSpringDao{
	...
	public List<Object[]> findTotTransactionsRateforAll(Long userId,
		...
		logger.info("Transactions Report graph query :"+qry);
		return  getHibernateTemplate().find(qry);
	}
	...
	public int getAllTransactionsCount(Long userId,
		...
		logger.info("T.Report Query : "+qry);
		List tempList = getHibernateTemplate().find(qry);
	...
	public List<Object[]> getAllTransactions(Long userId,
		...
		logger.info("Transactions Query:"+qry);		
...
public Object[] getTrxSummeryByDate(Long userID, Long prgmId, String startDateStr, String endDateStr,
	...
	public List<LoyaltyTransactionChild> getOriginalRedemptionTrx(Long userId,Long loyaltyId, String docId) {
		
		String query  = "SELECT * FROM LoyaltyTransactionChild WHERE userId="+userId+" AND loyaltyId="+loyaltyId+" "
				+ "AND transactionType='Redemption' AND docSID='"+docId+"' ";
		
		List<LoyaltyTransactionChild> tempList = executeQuery(query);
