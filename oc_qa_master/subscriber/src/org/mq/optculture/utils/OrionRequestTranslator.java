...
public class OrionRequestTranslator {
	...
	public DigitalReceipt convertOrionRequest(OrionDRRequest orionRequest, Users userObj) {
		...
		User orionUser = orionRequest.getHead().getUser();

		DRHead Head = new DRHead();
		User user = new User(orionUser.getUserName(), orionUser.getToken(), orionUser.getOrganizationId());
		Head.setUser(user);
		Head.setEmailReceipt(orionDRHead.getEmailReceipt());
		Head.setEnrollCustomer(orionDRHead.getEnrollCustomer());
		Head.setPrintReceipt(orionDRHead.getPrintReceipt());
		Head.setRequestFormat(orionDRHead.getRequestFormat());
		Head.setRequestSource(orionDRHead.getRequestSource());
		Head.setRequestEndPoint(orionDRHead.getRequestEndPoint());
		Head.setIsLoyaltyCustomer(orionDRHead.getIsLoyaltyCustomer());
		...
		if (orionOCDetails != null) {
			Gson gson = new Gson();
			gson = new Gson();
			String json = gson.toJson(orionOCDetails);
