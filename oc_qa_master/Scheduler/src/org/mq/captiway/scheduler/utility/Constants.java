...
public interface Constants {
	...
	String AUTO_SMS_SENTID_SUFFIX_FOR_SMPP = "004";
	...
	String EQ_STATUS_SUBMITTED="Submitted";
	...
	/**
	 * No HTMLCONTENT in campaign while sending campaign
	 */
	String NO_HTMLCONTENT_CAMPAIGN_SUBJECT = "NOHTMLCONTENTCAMPAIGNSUBJECT";
	String NO_HTMLCONTENT_CAMPAIGN_EMAIL_CONTENT = "NoHTMLCONTENTinscheduledcampaign";
	...
	String CONT_STATUS_BLOCKED = "Blocked";
	/**
	 * TempConstants
	 */
	...
	String WA_SENT_STATUS_STATUS_PENDING = "Status Pending";
	String WA_STATUS_NotSubmitted = "NotSubmitted";
	String WA_STATUS_Submitted = "Submitted";
	String WA_SENT_STATUS_DELIVERED = "Delivered";
	String PROPS_KEY_WA_THREAD_COUNT = "WAThreadCount";
	String EndPoint_CM = "https://gw.cmtelecom.com/v1.0/message";
	String EndPoint_MsgBird ="https://conversations.messagebird.com/v1/send";
	String MetaEndPoint = "https://graph.facebook.com/";
...
/**
	 ...
	 String COUP_GENT_CAMPAIGN_TYPE_WA = "WA";
	 String COUP_GENT_CAMPAIGN_TYPE_PUSHNOTIFICATION = "PN";
	 String COUP_GENT_YPE_PUSHNOTIFICATION = "PNWeb";
	...
	String SEGMENT_ON_NOTIFICATION = "SEGMENT_ON_NOTIFICATION";
	  ...
	  String URL_PARAM_SG_EMAIL = "Email";
	  String URL_PARAM_EQ_EMAIL= "EQID";
	  
	  String SES_REPORT_TYPE = "notificationType";
	  String SP_REPORT_TYPE= "msys";
	  ...
	  String EXTERNAL_SMTP_EVENTS_TYPE_DELIVERED = "delivered";
	  ...
	  //added for ses
	  String EXTERNAL_SMTP_EVENTS_TYPE_COMPLAINT ="complaint";
	  ...
	  String DR_JSON_MODE_ONLINE="online";
	  String DR_JSON_MODE_OFFLINE="offline";
	  ...
	  /**
		...
		String SMTP_AMAZONSES ="AmazonSES";
		String SMTP_SPARKPOST = "SparkPost";
		String SMTP_MAILERCLOUD ="MailerCloud";
		//sending type
		String SENDING_TYPE_SINGLE = "AutoEmail";
		String SENDING_TYPE_BULK ="CampaignSchedule";
		...
		String SMTP_KEY_TLS_ENABLE = "mail.smtp.starttls.enable";
		...
		/**
		 * Alert message of file upload failed 
		 */
		
		String CONTACTS_FILE_UPLOAD_FAILED = "Contacts File Upload Failed Alert";
		String SKU_FILE_UPLOAD_FAILED = "SKU File Upload Failed Alert";
		String SALES_FILE_UPLOAD_FAILED = "Sales File Upload Failed Alert";
		
		String CONTACTS_FILE = "contacts File";
		String SKU_FILE = "SKU";
		String SALES_FILE = "sales";
		
		
		String FILE_UPLOAD_FAILED_ALERT_PH_FILE_NAME  = "<unProcessed_file_name>";
		String FILE_UPLOAD_FAILED_ALERT_PH_ORG_ID  = "<org_id>";
		String FILE_UPLOAD_FAILED_ALERT_PH_USER_NAME  = "<username>";
		String FILE_UNPROCCESSED_TIME="<timestamp>";
		String FILE_TYPE="<fileType>";
		
		String EQ_TYPE_FAILED_FILES = "Uprocessed files Alert";
		String LIST_FILES="<files>";
		String NO_OF_FILES="<number_of_files>";
		String DATE="<date>";
		String STRING_NOTAMEMBER ="Not a Member";
