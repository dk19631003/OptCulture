...
public interface PlaceHolders {
	...
	// String CAMPAIGN_PH_ORGANIZATION_NAME ="organizationName";
	 ...
	 String CAMPAIGN_PH_FACEBOOK_URL = "shareOnFacebook";
 	 ...
 	 String CAMPAIGN_FOOTER_UNSUBSCRIBE = "|^GEN_unsubscribeLink^|";
 	 //String SENDER_FOOTER_EMAIL_ADDRESS_AUTOEMAIL = "|^GEN_senderEmailAddress^|";
 	 String SENDER_FOOTER_EMAIL_ADDRESS_AUTOEMAIL = "|^GEN_email / DEFAULT=^|"; 
 	 String SENDER_FOOTER_EMAIL_ADDRESS_AUTOEMAIL_WITH_BRACES= "[GEN_email / DEFAULT=]";
