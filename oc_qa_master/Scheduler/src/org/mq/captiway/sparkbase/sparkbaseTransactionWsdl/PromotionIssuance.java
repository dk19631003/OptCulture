...
/**
 * A request to perform a promotion issuance transaction. A promotion issuance transaction can be used to add punches or custom value to an account. It may also create and change customer information associated with an account.
 * 
...
@XmlRootElement(name = "PromotionIssuance")
public class PromotionIssuance {
