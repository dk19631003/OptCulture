...
public enum MagentoDREnum {
		...
		//base_price(1,orderitems,null,"base_price","#Item.UnitPrice#",false, true,"InvcItemPrc"),
		...
		qty_ordered(1,Items,null,"qty_ordered","#Item.Quantity#", false, false,"Qty"),
		...
		//entity_id(1,DRDocument,null,"entity_id","#Receipt.Number#", false, false,"InvcNum"),
		...
		private MagentoDREnum(long fieldId, MagentoDREnum parent, String rootElementName, String elementName,String hashTag, boolean decimal, boolean number) {
		...
		private MagentoDREnum(long fieldId, MagentoDREnum parent, String rootElementName, String elementName,String hashTag, boolean decimal, boolean number, boolean checkVisibility) {
			this.fieldId = fieldId;
			this.parent = parent;
			this.rootElementName = rootElementName;
			this.elementName = elementName;
		...
		private MagentoDREnum(long fieldId, MagentoDREnum parent, String rootElementName, String elementName,String hashTag, boolean decimal, boolean number, String OptDRJsonEleName) {
			this.fieldId = fieldId;
			this.parent = parent;
			this.rootElementName = rootElementName;
			this.elementName = elementName;
		...
		public MagentoDREnum getParent() {
			return parent;
		}



		public void setParent(MagentoDREnum parent) {
			this.parent = parent;
		}
	...
	public static MagentoDREnum getEnumsByHashTag(String hashTag) {
			
			
		MagentoDREnum[] childEnum = MagentoDREnum.values();
			for (MagentoDREnum magentoDREnum : childEnum) {
