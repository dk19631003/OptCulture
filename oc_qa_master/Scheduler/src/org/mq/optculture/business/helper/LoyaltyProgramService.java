...
public class LoyaltyProgramService {
	 ...
	 */
	public LoyaltyTransactionChild getTransByMembershipNoAndTransType(Long userId, Long loyaltyId,String transactionType){
		...
		try {
			...
			loyaltyTransactionChild = loyaltyTransactionChildDao.getTransByMembershipNoAndTransType(userId, loyaltyId,transactionType);
		}catch (Exception e) {
			logger.error("Exception ::",e);
		}
