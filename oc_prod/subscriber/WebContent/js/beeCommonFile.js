...
},
{
		...
		beeConfig = {  
			      ...
			      rowsConfiguration: {
			            ...
			            externalContentURLs: [{
			                name: "Items",
			                value: "https://app.optculture.com/subscriber/savedRows.mqrm?name=items"
			                },{
			                  name: "Payments",
			                  value: "https://app.optculture.com/subscriber/savedRows.mqrm?name=payments"
			                  },{
			                    name: "Store Info",
			                    value: "https://app.optculture.com/subscriber/savedRows.mqrm?name=store info"
			                    },{
			                      name: "Bill-to-Ship-to",
			                      value: "https://app.optculture.com/subscriber/savedRows.mqrm?name=bill-to-ship-to"
			                  	  },{
			                        name: "Store Policy",
			                        value: "https://app.optculture.com/subscriber/savedRows.mqrm?name=store policy"
			                   	    },{
			                          name: "Auto Turn-Off",
			                          value: "https://app.optculture.com/subscriber/savedRows.mqrm?name=auto turn-off"
			                       	  }]         
			        },
			        onChange: function (jsonFile, response){
			        	console.log('response',response);
