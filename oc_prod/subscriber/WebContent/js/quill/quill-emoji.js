! function (e, o) {
	"object" == typeof exports && "object" == typeof module ? module.exports = o(require("quill")) : "function" == typeof define && define.amd ? define(["quill"], o) : "object" == typeof exports ? exports.QuillEmoji = o(require("quill")) : e.QuillEmoji = o(e.Quill)
}(window, function (a) {
	return function (a) {
		var r = {};
		...
		return c.m = a, c.c = r, c.d = function (e, o, a) {
			...
			if (c.r(a), Object.defineProperty(a, "default", {
				...
				for (var r in o) c.d(a, r, function (e) {
					return o[e]
				}.bind(null, r));
			return a
		}, c.n = function (e) {
		...
		r = function () {
			return function (a) {
				...
				"./src/bitap/bitap_matched_indices.js": function (e, o) {
					e.exports = function () {
				...
				"./src/bitap/bitap_pattern_alphabet.js": function (e, o) {
				...
				"./src/bitap/bitap_regex_search.js": function (e, o) {
					var _ = /[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g;
					e.exports = function (e, o) {
						var a = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : / +/g,
							...
							d = [];
						if (n)
							for (var i = 0, m = c.length; i < m; i += 1) {
								var t = c[i];
				...
				"./src/bitap/bitap_score.js": function (e, o) {
					e.exports = function (e, o) {
						var a = o.errors,
							r = void 0 === a ? 0 : a,
							c = o.currentLocation,
				...
				"./src/bitap/bitap_search.js": function (e, o, a) {
				...
				"./src/bitap/index.js": function (e, o, a) {
					function r(e, o) {
				...
				"./src/helpers/deep_value.js": function (e, o, a) {
					...
					e.exports = function (e, o) {
						return function e(o, a, r) {
							if (a) {
								var c = a.indexOf("."),
									n = a,
									d = null; - 1 !== c && (n = a.slice(0, c), d = a.slice(c + 1));
								var i = o[n];
								if (null != i)
									if (d || "string" != typeof i && "number" != typeof i)
										if (_(i))
											for (var m = 0, t = i.length; m < t; m += 1) e(i[m], d, r);
										else d && e(i, d, r);
				...
				"./src/helpers/is_array.js": function (e, o) {
					e.exports = function (e) {
						return Array.isArray ? Array.isArray(e) : "[object Array]" === Object.prototype.toString.call(e)
					}
				},
				"./src/index.js": function (e, o, a) {
					function _(e) {
							...
							return e = R, (o = [{
								...
								value: function () {
									...
									if (this.options.tokenize)
										for (var a = e.split(this.options.tokenSeparator), r = 0, c = a.length; r < c; r += 1) o.push(new n(a[r], this.options));
									return {
										tokenSearchers: o,
								...
								value: function () {
									...
									for (var i = {}, m = 0, t = a.length; m < t; m += 1)
										for (var _ = a[m], l = 0, s = this.options.keys.length; l < s; l += 1) {
								...
								value: function (e, o) {
									...
									if (null != n) {
										...
										if ("string" == typeof n) {
											...
											var M = p.score; - 1 < y && (M = (M + y) / 2), this._log("Score average:", M);
											...
											for (var P = 0, A = n.length; P < A; P += 1) this._analyze({
												key: a,
												arrayIndex: P,
												value: n[P],
												record: d,
					...
					value: function (e) {
						...
						if (e.forEach(function (e, o) {
								...
								n.container.appendChild(c), d[o] = c.firstChild, d[o].addEventListener("keydown", (a = o, r = e, function (e) {
									if ("ArrowRight" === e.key || 39 === e.keyCode) e.preventDefault(), d[Math.min(d.length - 1, a + 1)].focus();
									else if ("Tab" === e.key || 9 === e.keyCode) {
							...
							var o, a = this.container.querySelectorAll("li");
				...
				return function (e, o) {
					...
					value: function () {
						...
						e = r, (o = document.getElementById("emoji-palette")) ? o.remove() : function (c) {
							...
							var r = a.left + 250;
							e.id = "emoji-palette", e.style.top = 10 + a.top + a.height + "px", r > c.container.offsetWidth ? e.style.left = a.left - 250 + "px" : e.style.left = a.left + "px";
							...
							[{
								...
								var a = e.content;
								o.innerHTML = a, o.dataset.filter = e.type, i.appendChild(o);
								var r = document.querySelector(".filter-" + e.name);
								r.addEventListener("click", function () {
									var e = document.querySelector(".active");
									e && e.classList.remove("active"), r.classList.toggle("active"),
										function (e, o, a) {
											for (; o.firstChild;) o.removeChild(o.firstChild);
											R(e.dataset.filter, o, a)
										}(r, d, c)
								})
							}), R("p", d, c), document.querySelector(".filter-people").classList.add("active")
		...
		var W = m.a.import("core/module"),
			Q = function (e) {
				...
				return function (e, o) {
					...
					value: function () {
						var e, o, a = document.getElementById("textarea-emoji");
						if (a) a.remove();
						else {
