...
public class LoyaltyIssuanceOCRestService extends AbstractController{
	...
	protected ModelAndView handleRequestInternal(HttpServletRequest request,
		...
		logger.info("Started Loyalty Issuance Rest Service... at "+System.currentTimeMillis()+" for "+request.getRemoteHost()+" ");
		...
		try{
			...
			updateTransaction(tranParent, issuanceResponse, userName);
			logger.info("Response = "+responseJson);
			logger.info("Ended Loyalty Issuance Rest Service... at "+System.currentTimeMillis()+" for "+request.getRemoteHost()+" ");
			return null;
		}finally{
			logger.info("Response = "+responseJson);
