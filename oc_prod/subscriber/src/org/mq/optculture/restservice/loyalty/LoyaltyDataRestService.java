...
public class LoyaltyDataRestService extends AbstractController{
	...
	protected ModelAndView handleRequestInternal(HttpServletRequest request,
		...
		try{
			...
			BaseService baseService = ServiceLocator.getInstance().getServiceByName(OCConstants.LOYALTY_DATA_BUSINESS_SERVICE_IMPL);
