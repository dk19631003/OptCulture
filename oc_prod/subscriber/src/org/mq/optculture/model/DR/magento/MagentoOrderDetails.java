...
public class MagentoOrderDetails {
		...
		private String forced_shipment_with_invoice;
		private String payment_auth_expiration;
		private String quote_address_id;
		private String quote_id;
		private String shipping_address_id;
		private String adjustment;
		private String base_adjustment;
		...
		private String loyalty_data;
		private String loyalty_promotions;
		//@JsonIgnore
		//private MagentoAddresses addresses;
		private String order_id; //for returns
	...
	public String getForced_shipment_with_invoice() {
		return forced_shipment_with_invoice;
	}
	public void setForced_shipment_with_invoice(String forced_shipment_with_invoice) {
		this.forced_shipment_with_invoice = forced_shipment_with_invoice;
	}
	public String getPayment_auth_expiration() {
		return payment_auth_expiration;
	}
	public void setPayment_auth_expiration(String payment_auth_expiration) {
	...
	public void setBase_adjustment(String base_adjustment) {
	...
	public String getShipping_discount_tax_compensation_amount() {
		return shipping_discount_tax_compensation_amount;
	}
	public void setShipping_discount_tax_compensation_amount(String shipping_discount_tax_compensation_amount) {
		this.shipping_discount_tax_compensation_amount = shipping_discount_tax_compensation_amount;
	}
	public String getBase_shipping_discount_tax_compensation_amnt() {
		return base_shipping_discount_tax_compensation_amnt;
	}
	public void setBase_shipping_discount_tax_compensation_amnt(String base_shipping_discount_tax_compensation_amnt) {
	...
	public String getLoyalty_data() {
		return loyalty_data;
	}
	public void setLoyalty_data(String loyalty_data) {
		this.loyalty_data = loyalty_data;
	}
	public String getLoyalty_promotions() {
		return loyalty_promotions;
	}
	public void setLoyalty_promotions(String loyalty_promotions) {
		this.loyalty_promotions = loyalty_promotions;
	}
	/*public MagentoAddresses getAddresses() {
		return addresses;
	}
	public void setAddresses(MagentoAddresses addresses) {
