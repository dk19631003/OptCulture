...
public class DRItem {
	...
	private String DocItemTotalDiscAmt;
...
public void setItemPromoDiscount(String itemPromoDiscount) {
	...
	public String getDocItemTotalDiscAmt() {
		return DocItemTotalDiscAmt;
	}


	public void setDocItemTotalDiscAmt(String docItemTotalDiscAmt) {
		DocItemTotalDiscAmt = docItemTotalDiscAmt;
	}


	public String getDocItemDiscPrc() {
		return DocItemDiscPrc;
	}


	public void setDocItemDiscPrc(String docItemDiscPrc) {
		DocItemDiscPrc = docItemDiscPrc;
	}


	private String DocItemDiscPrc;
