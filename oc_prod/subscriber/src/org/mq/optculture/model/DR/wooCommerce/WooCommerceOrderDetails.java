...
public class WooCommerceOrderDetails {
	...
	//private List<WooCommerceShippingLines> shipping_lines;
	//private List<WooCommerceTaxLines> tax_lines;
	//private List<WooCommerceFeeLines> fee_lines;
	//private List<WooCommerceCouponLines> coupon_lines;
	//private List<WooCommercePaymentDetails> payment_details;
