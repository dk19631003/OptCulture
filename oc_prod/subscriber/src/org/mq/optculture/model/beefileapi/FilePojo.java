...
public class FilePojo {
	...
	public void setPublicurl(String publicurl) {
		...
		try {
			...
			//String encryptedImageName=URLEncoder.encode(imageName, "UTF-8");
			String encryptedImageName=URLEncoder.encode(imageName, "UTF-8").replace("+", "%20");
			logger.info("publicUrl before encryption.."+publicurl);
			publicurl=publicurl.replace(imageName, encryptedImageName);
			logger.info("publicUrl after encryption.."+publicurl);*/
			...
			logger.info("While encrypting publicurl Error",e);
		}
		this.publicurl = publicurl;
	}
	...
	public void setThumbnail(String thumbnail) {
		//TODO encoding only for imageName done
				try {
					...
					logger.info("While encrypting thumbnail Error",e);
				}
		this.thumbnail = thumbnail;
	}
