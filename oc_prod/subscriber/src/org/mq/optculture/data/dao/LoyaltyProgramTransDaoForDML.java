...
public class LoyaltyProgramTransDaoForDML extends AbstractSpringDaoForDML{
	...
	public LoyaltyProgramTransDaoForDML() {
	}
	
	public void saveOrUpdate(LoyaltyProgramTrans loyaltyProgramTrans) {
		super.saveOrUpdate(loyaltyProgramTrans);
	}
