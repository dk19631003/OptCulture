...
public class ReferralcodeProvider {
	...
	private static ReferralcodeProvider referralcodeProvider;
	 ...
	 public synchronized String  getNextCouponCode(String tempStr, String campaignName, String campaignType, 
				String issuedTo, Long sentId, String smsContent,Long contactId,Long userId) {
			
		 logger.info("entering getNextCouponCode first method");

		 return getNextCouponCode(tempStr,campaignName, campaignType, issuedTo, sentId, smsContent, contactId,false,userId);
		 
	 }
	    
		public synchronized String  getNextCouponCode(String tempStr, String campaignName, String campaignType, 
												String issuedTo, Long sentId, String smsContent,Long contactId, boolean flushToDB,Long userId) {
			try {
...
//				Long userid=null;
							...
							logger.info("entering for loop getNextCouponCodereferral method");
							 ...
							 if(eachPh.startsWith("REF_CC_")) {
								...
								try {
									...
									logger.info("Temp queue :"+tempQue);
									
									if(tempQue!=null && !tempQue.isEmpty()) {
										logger.info("entered tempque");
				...
				tempCC.setStatus(Constants.COUP_STATUS_ACTIVE);
