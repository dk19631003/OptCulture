...
public class DRItem {
	...
	public DRItem() {
		 ...
		 setExtTax2("");
		 setExtTotalTax("");
		 setDiscountPercentWithTax("");
		 setDiscountAmountWithTax("");
		 setFCOriginalPrice("");
		 setFCOriginalPriceWithTax("");
		 setFCOriginalExtendedPrice("");
		 setFCOriginalExtendedPriceWithTax("");
		 setFCPrice("");
		 setFCPriceWithTax("");
		 setFCExtendedPrice("");
		 setFCExtendedPriceWithTax("");
		 setSerialNum("");
		 setItemNote1("");
		 setItemNote2("");
		 setItemNote3("");
