...
public class TransactionalTemplatesDao extends AbstractSpringDao {
   ...
   /* public void delete(TransactionalTemplates transactionalTemplates){
	...
	public TransactionalTemplates find(Long id) {
		try {
		List<TransactionalTemplates> templateList = null;
		String query = "FROM TransactionalTemplates WHERE transactionId="+id+"";
