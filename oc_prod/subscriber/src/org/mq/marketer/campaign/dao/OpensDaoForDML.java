...
public class OpensDaoForDML extends AbstractSpringDaoForDML {
    public OpensDaoForDML() {}
   ...
   /* public List findAll() {
    ...
    public List<Map<String, Object>> getDesktopReportByCrId(Long crId) {
    	...
    	String qry="SELECT t1.osf as osfamily, count(t1.tot_count) as osfcount FROM " +
    			...
    			" WHERE ec.email_client='"+Constants.UA_TYPE+"' AND ec.user_agent IN('Email_Client','Browser','Email Client') ) " +
    ...
    public List<Map<String, Object>> getPhoneReportByCrId(Long crId) {
...
public List<Map<String, Object>> getEmailClientReportByCrId(Long crId) {
	...
	String qry="SELECT t1.uaf as uafamily, count(t1.tot_count) as uafcount FROM " +
			...
			" FROM opens o, campaign_sent cs WHERE o.sent_id=cs.sent_id and cs.cr_id=" + crId.longValue() +
			" and o.email_client in(select distinct ec.id from email_clients ec " +
			" WHERE ec.email_client='"+Constants.UA_TYPE+"' AND ec.user_agent in('Email Client','Email_Client' )) " +
...
public List<Map<String, Object>> getMobileBrowserReportByCrId(Long crId) {
...
public List<Map<String, Object>> getBrowserReportByCrId(Long crId) {
