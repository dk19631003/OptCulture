...
public class DigitalReceiptsJSONDaoForDML extends AbstractSpringDaoForDML{
	...
	public DigitalReceiptsJSONDaoForDML(){}
	...
	public void updateIgnoredStatus(String status,Long userId) {	
		
		String updateQry = " UPDATE digital_receipts_json SET status='"+OCConstants.DR_STATUS_IGNORED+"' WHERE user_id="+userId+" "
							+ "AND status ='"+Constants.DR_JSON_PROCESS_STATUS_NEW+"' ";
