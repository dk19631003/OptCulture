...
public class TemplateCategoryDao extends AbstractSpringDao {
...
/*
    ...
    public List findNewEditorCategories(){
    	return getHibernateTemplate().find("from TemplateCategory where categoryName in ('Basic Templates','My NewEditor Templates') order by cratedDate");
    }
