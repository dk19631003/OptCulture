...
//	CONTACT_SUBSCRIPTION_FORM_SETTINGS("contact/subscriptionFormSettings", RightsEnum.MenuItem_AdminWebform_READ),
    ...
    LOYALTY_PROGRAM_OVERVIEW("loyalty/loyaltyPrgmOverview",  RightsEnum.MenuItem_Create_Loyalty_READ),
    LOYALTY_PROGRAM_DETAILED_REPORT("report/loyaltyDetailedReport",  RightsEnum.MenuItem_Create_Loyalty_READ),
