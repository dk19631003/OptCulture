...
public SpecialReward(){}
	...
	public void setDeductItemPrice(Boolean deductItemPrice) {
	 ...
	 //for description2
	private String itemsSatisfied;
	public String getItemsSatisfied() {
		return itemsSatisfied;
}
	public void setItemsSatisfied(String itemsSatisfied) {
		this.itemsSatisfied = itemsSatisfied;
	}
	public Double getExcludeQty() {
		return excludeQty;
	}
	public void setExcludeQty(Double excludeQty) {
	...
	public String getIssuanceWindow() {
		return issuanceWindow;
	}
	public void setIssuanceWindow(String issuanceWindow) {
