...
private Map<String ,String> tokenMapForIyD;
	...
	public void onClick$getNumOfContactsAnchId() {
		...
		*/
		...
		long mlsbit = Utility.getMlsBit(mlSet);
			String segmentQueryStr = SalesQueryGenerator.generateListSegmentCountQuery( segmentRuleSB.toString(), true, Constants.SEGMENT_ON_EXTERNALID, mlsbit);
		...
		int allSize = contactsDao.getSegmentedContactsCount(segmentQueryStr);
		...
		int emailSize = contactsDao.getSegmentedContactsCount(segmentQueryStr);
	...
	// Mobile Contacts
		...
		int mobileSize = contactsDao.getSegmentedContactsCount(segmentQueryStr);
	...
	public void saveRule(boolean isEdit) {
		...
		*/
		...
		logger.debug("segmentRuleSB ::"+segmentRuleSB.toString());
			...
			String totSegmentCountQry = SalesQueryGenerator.generateListSegmentCountQuery( segmentRuleSB.toString(), true, Constants.SEGMENT_ON_EXTERNALID, mlsbit);
			...
			String emailSegmentQueryStr = SalesQueryGenerator.generateListSegmentQuery( segmentRuleSB.toString(), false, Constants.SEGMENT_ON_EMAIL, mlsbit);
			...
			String emailSegmentCountQueryStr = SalesQueryGenerator.generateListSegmentCountQuery( segmentRuleSB.toString(), false, Constants.SEGMENT_ON_EMAIL, mlsbit);
			...
			String mobileSegmentQueryStr = SalesQueryGenerator.generateListSegmentQuery( segmentRuleSB.toString(), false, Constants.SEGMENT_ON_MOBILE, mlsbit);
			...
			String mobileSegmentCountQueryStr = SalesQueryGenerator.generateListSegmentCountQuery( segmentRuleSB.toString(), false, Constants.SEGMENT_ON_MOBILE, mlsbit);
			...
			int size = contactsDao.getSegmentedContactsCount(emailSegmentCountQueryStr);
			int totSize = contactsDao.getSegmentedContactsCount(totSegmentCountQry);
			int totMobileCount = contactsDao.getSegmentedContactsCount(mobileSegmentCountQueryStr);
