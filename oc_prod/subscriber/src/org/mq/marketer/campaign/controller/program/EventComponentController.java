 ...
 *
 */
public class EventComponentController extends GenericForwardComposer {
	...
	Window eventComponentWinId;
	public void onClick$eventComponentWinId() {
		
		if ( arg != null && !arg.containsKey( "deSelect" )) {
			Canvas canvas = (Canvas)eventComponentWinId.getParent();
			...
			eventComponentWinId.setBorder("normal");
			eventComponentWinId.setStyle("position:absolute;padding:0px;");
			
		}
		
		
		
	}//onClick$eventComponentWinId()
