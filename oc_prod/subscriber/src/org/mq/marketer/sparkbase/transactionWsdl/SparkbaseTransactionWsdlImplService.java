 ...
 * 
 */
@WebServiceClient(name = "SparkbaseTransactionWsdlImplService", targetNamespace = "urn:SparkbaseTransactionWsdl", wsdlLocation = "https://trans.api.sparkbase.com/v4/transaction?wsdl")
    ...
    static {
        ...
        try {
           ...
           //url = new URL(baseUrl, "https://trans.api.factor4gift.com/v4/transaction?wsdl");
            url = new URL(baseUrl, "https://trans.api.sparkbase.com/v4/transaction?wsdl");
        	...
        	logger.warning("Failed to create URL for the wsdl Location: 'https://trans.api.sparkbase.com/v4/transaction?wsdl', retrying as a local file");
