...
/**
 * A request to perform an enrollment transaction. An enrollment transaction can be used to add points to an account or to create and change customer information associated with an account.
 * 
