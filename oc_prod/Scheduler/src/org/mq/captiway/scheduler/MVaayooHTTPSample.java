...
public MVaayooHTTPSample(String userID, String pwd) {
	...
	public static void main(String[] args) {
		...
		try {
			 ...
			 */
			MVaayooHTTPSample obj = new MVaayooHTTPSample("amith.lulla@optculture.com", "amithl");
			obj.test("Thanks for shopping with Tresmode", "9490927928,9989811518", "OPTCLT");
