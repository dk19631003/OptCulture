...
public class UserScoreSettingsDao extends AbstractSpringDao {
	
	private static final Logger logger = LogManager.getLogger(Constants.SCHEDULER_LOGGER);
	
	public UserScoreSettingsDao(){}
   ...
   /* public List<UserScoreSettings> findByUserGroupNameSrcOfVisitCount(Long userId, String scoreGroupName){
    	return getHibernateTemplate().find("from UserScoreSettings us where us.groupName like '%scoreGroupName%'
				 and us.user="+ userId +"");
    }*/
