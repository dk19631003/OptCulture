...
/**
 * A request to perform a loyalty redemption transaction. A loyalty redemption transaction can be used to remove points value from an account. It may also create and change customer information associated with an account.
 * 
