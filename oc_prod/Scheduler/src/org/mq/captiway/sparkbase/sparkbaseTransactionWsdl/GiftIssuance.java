...
/**
 * A request to perform a gift issuance transaction. A gift issuance transaction can be used to add currency value to an account. It may also create and change customer information associated with an account.
 * 
...
@XmlRootElement(name = "GiftIssuance")
public class GiftIssuance {
