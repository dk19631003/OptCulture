...
public class TravellerCheck {
	...
	public TravellerCheck(){}
	public TravellerCheck(String amount, String number, String firstName, String lastName, String workPhone,
			String homePhone, String stateCode, String company, String driverLicense, String driverLicenseExp,
			String dateOfBirth, String taken, String given, String currencyName) {
		Amount = amount;
		Number = number;
		FirstName = firstName;
		LastName = lastName;
