...
public class SMSGatewaySessionMonitor extends TimerTask{
	...
	public void run() {
		...
		try {
			...
			GatewaySessionProvider sessionProvider = GatewaySessionProvider.getInstance();//by this time everything will be done
	...
	public  void performDlrUpdations(GatewaySessionProvider sessionProvider) {
		...
		SMSDlrReportUpdateThread dlrProcessThread = new SMSDlrReportUpdateThread(unicelDlrReciepts, infoBipDlrReciepts, updateStatusMap);
