...
public enum POSFieldsEnum {
	...
	recieptNumber(32, "RecieptNumber", "RecieptNumber", "Receipt Number", "reciept_number", "Receipt::InvcNum", "", "Long"),
	...
	//pojo reflection Field, pos attribute(CSV), OC attribute, DBColumn, DR key field, phAttribute ,Datatype
	vendorCode(48,"VendorCode", "VC" , "Vendor", "vendor_code", "", "", "String" ),
	departMentCode(49,"DepartmentCode", "D_Code" , "Department", "department_code", "", "", "String" ),
	classCode(50,"ClassCode", "C_Code" , "Class", "class_code", "", "", "String" ),
	Sclass(51,"SubClassCode", "S_Code" , "Subclass", "subclass_code", "", "", "String" ),
	dcs(52,"DCS", "DCS" , "DCS", "dcs", "", "", "String" ),
	;
