...
/**
 * A request to perform a promotion redemption transaction. A promotion redemption transaction can be used to remove punches or custom value from an account. It may also create and change customer information associated with an account.
 * 
