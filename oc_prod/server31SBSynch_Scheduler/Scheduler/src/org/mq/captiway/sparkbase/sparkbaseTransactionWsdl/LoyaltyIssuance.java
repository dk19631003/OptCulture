...
/**
 * A request to perform a loyalty issuance transaction. A loyalty issuance transaction can be used to add points value to an account. It may also create and change customer information associated with an account.
 * 
...
@XmlRootElement(name = "LoyaltyIssuance")
public class LoyaltyIssuance {
