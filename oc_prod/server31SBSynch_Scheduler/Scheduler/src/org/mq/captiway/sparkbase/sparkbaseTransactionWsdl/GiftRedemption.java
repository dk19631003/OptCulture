...
/**
 * A request to perform a gift redemption transaction. A gift redemption transaction can be used to remove currency value from an account. It may also create and change customer information associated with an account.
 * 
 ...
 *         &lt;element name="includeTip" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlRootElement(name = "GiftRedemption")
public class GiftRedemption {
    ...
    /**
     * Gets the value of the includeTip property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the includeTip property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setIncludeTip(String value) {
        this.includeTip = value;
    }
