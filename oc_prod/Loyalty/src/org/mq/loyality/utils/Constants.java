...
public interface Constants {
	...
	String CONT_STATUS_PURGE_PENDING = "Purge pending";
	 ...
	 List<String> PLACEHOLDERS_LIST = new ArrayList<String>() {
		{
			...
			add("Created Date::|^GEN_createdDate / DEFAULT=^|");
			add("Organization Name::|^GEN_organizationName / DEFAULT=Not Available^|");
			add("Store Name::|^GEN_storeName / DEFAULT=Not Available^|");
			add("Store Manager::|^GEN_storeManager / DEFAULT=^|");
			add("Store Phone::|^GEN_storePhone / DEFAULT=^|");
			add("Store Email::|^GEN_storeEmail / DEFAULT=^|");
			add("Store Street::|^GEN_storeStreet / DEFAULT=^|");
			add("Store City::|^GEN_storeCity / DEFAULT=^|");
			add("Store State::|^GEN_storeState / DEFAULT=^|");
			add("Store Zip::|^GEN_storeZip / DEFAULT=^|");
			add("Last Purchase Store Address::|^GEN_lastPurchaseStoreAddress / DEFAULT=Not Available^|");
...
// webform 
 ...
 //Added for Referral profaram
	...
	// Added for Subscriber preference center
		...
		String EQ_TYPE_LOYALTY_PHONE_UPDATE = null;
		
		String SUBJECT_CANT_LOGIN="Your loyalty membership details";
		String SUBJECT_CHANGE_PASSWORD ="Your loyalty account's password has been updated successfully";
		String OTP_MESSAGE="OtpMessage";
}
